# Corrected Update Post Subdomains Creation
...
### Handle Divergent Branches (If Needed)

**If you see "divergent branches" error, use one of these:**
...
**Current Issue:** Files are owned by `root:root`, but Nginx needs `www-data:www-data`.
...
- **Step 1:** 1 minute (SSH)
- **Step 2:** 2 minutes (pull code, handle divergent branches)
- **Steps 3-5:** 15 minutes (build and deploy apps)
- **Step 6:** 1 minute (fix permissions)
- **Steps 7-12:** 15 minutes (Nginx setup)
- **Step 13:** 2 minutes (test HTTP)
- **Step 14:** 10 minutes (SSL certificates)
- **Step 15:** 5 minutes (update CORS)
- **Step 16:** 5 minutes (testing)

**Total:** ~56 minutes

---

**Follow these steps in order, starting with Step 1!**

**Key Fix:** Step 2 now includes instructions for handling divergent branches.
